...
object Dependencies {
  ...
  object ZIO {
    ...
    private val zioConfigVersion = "4.0.1"
    val config = Seq(
    ...
    private val zioLoggingVersion = "2.1.16"
  ...
  object FlyWay {
    ...
    val driver = "org.postgresql" % "postgresql" % "42.7.1"
  ...
  object Doobie {
    ...
    val quillJdbc = "io.getquill" %% "quill-jdbc" % "4.8.0"
  ...
  object Config {
    ...
    val pureconfigRefined = "eu.timepit" %% "refined-pureconfig" % "0.11.0"
