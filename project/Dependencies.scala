...
object Dependencies {
  ...
  object ZIO {
    ...
    private val zioLoggingVersion = "2.1.10"
  ...
  object FlyWay {
    val flyWayCore = "org.flywaydb" % "flyway-core" % "9.15.1"
    val driver = "org.postgresql" % "postgresql" % "42.5.4"
    val all = Seq(flyWayCore, driver)
  }

  object Http4s {
    private val http4sVersion = "0.23.18"
    private val http4sBlazeVersion = "0.23.13"
