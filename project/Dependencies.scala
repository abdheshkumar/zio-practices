...
object Dependencies {
  ...
  object ZIO {
    ...
    private val zioLoggingVersion = "2.2.2"
  ...
  object FlyWay {
    ...
    val driver = "org.postgresql" % "postgresql" % "42.7.3"
  ...
  object Doobie {
    ...
    val quill = "io.getquill" %% "quill-doobie" % "4.8.3"
    val doobieH2 = "org.tpolecat" %% "doobie-h2" % doobieVersion
    val quillJdbc = "io.getquill" %% "quill-jdbc" % "4.8.3"
  ...
  object Config {
    ...
    val pureconfigRefined = "eu.timepit" %% "refined-pureconfig" % "0.11.1"
